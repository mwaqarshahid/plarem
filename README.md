...
| Geofencing | `@rn-org/react-native-geofencing` | Wraps the free, battery-efficient OS geofencing APIs; supports headless background triggers.
...
```
src/
  assets/        Brand mark PNGs used in-app (logo-icon, logo-white)
  components/    Reusable UI (Button, BrandLogo, Card, Chip, TextField, ReminderCard …)
  constants/     Brand palette, categories, radius presets, onboarding copy, config
...
- Radii below ~100 m are unreliable outdoors. That's why our in-app presets start at 100 m.
